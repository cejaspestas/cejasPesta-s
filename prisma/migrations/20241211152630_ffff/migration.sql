...
CREATE TABLE "new_Cliente" (
    ...
    CONSTRAINT "Cliente_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Equipo" (
    ...
    "rutaImagen" TEXT NOT NULL,
    "cargo" TEXT NOT NULL,
    CONSTRAINT "Equipo_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Imagen" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "ruta" TEXT NOT NULL,
    CONSTRAINT "Imagen_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Precio" (
    ...
    CONSTRAINT "Precio_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Promocion" (
    ...
    "tipoServicio" TEXT NOT NULL,
    "descripcion" TEXT NOT NULL,
    CONSTRAINT "Promocion_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Servicio" (
    ...
    "descripcion" TEXT NOT NULL,
    CONSTRAINT "Servicio_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Video" (
    ...
    "titulo" TEXT NOT NULL,
    "descripcion" TEXT NOT NULL,
    CONSTRAINT "Video_id_fkey" FOREIGN KEY ("id") REFERENCES "datosPagina" ("idhome") ON DELETE RESTRICT ON UPDATE CASCADE
);
