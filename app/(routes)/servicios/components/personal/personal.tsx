...
export const TeamDisplay = () => {
  ...
  return (
    <div className="bg-[rgb(0,0,0)] p-6 min-h-[80vh] border-t-2 flex justify-center items-center flex-col gap-y-20">
        ...
        {dataEquipo &&
          dataEquipo.map((member, index) => (
            ...
            >
              ...
              />
              <h3 className="text-lg font-semibold capitalize font-mono text-white">
                {member.cargo}
              </h3>
            </div>
          ))}
