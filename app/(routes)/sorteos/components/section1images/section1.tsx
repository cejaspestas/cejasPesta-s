...
export const Section1 = () => {
    ...
    return (
        <section className="relative p-4 w-[95%] sm:w-[90%] lg:w-[85%] min-h-screen lg:h-[120vh] flex flex-col items-center justify-center mx-auto gap-y-5 ">
            ...
            <div className="bg-gray-950  min-h-[100vh] w-full flex flex-col lg:flex-row justify-center items-center gap-y-5 lg:gap-x-5 mt-5 lg:mt-0 p-5 rounded-lg shadow-xl">
                {/* Sección de texto */}
