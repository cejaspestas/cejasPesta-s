...
export const ClienteHome = () => {
    return (
        <div className="relative bg-gradient-to-b from-gray-950 to-black text-white p-8 overflow-hidden min-h-[150vh] md:min-h-[110vh] flex items-center justify-center border-b-2 border-white">
