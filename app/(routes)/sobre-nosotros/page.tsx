...
export default function SobreNosotros() {
    ...
    return (
        <div className="min-h-screen bg-[rgb(12,12,12)] flex items-center justify-center">
            <div className="flex flex-col items-center justify-center h-full p-8 gap-y-10">
                {/* Título */}
                <h1 className="text-5xl font-bold text-white tracking-wide mb-6 text-center sm:text-3xl font-serif">
                    Sobre Nosotros
                </h1>

                {/* Imagen del logo */}
                <div className="relative w-[30vh] h-[30vh] rounded-full overflow-hidden shadow-2xl border-4 border-gray-700 sm:w-[20vh] sm:h-[20vh]">
                    <Image
                        src="/logo1.png"
                        alt="Logo"
                        fill
                ...
                {/* Descripción */}
                <p className="text-lg text-center max-w-3xl text-gray-300 leading-relaxed sm:text-base sm:max-w-md font-mono">
